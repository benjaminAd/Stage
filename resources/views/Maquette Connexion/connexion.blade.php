...
@section('body')
    ...
    <form class="text-center border border-light p-5 divConnect" action="#!">
        ...
        <div class="form-group">
            ...
            <input type="text" id="defaultLoginFormEmail" class="form-control mb-4" name="MailLog" placeholder="ex : ConnectanouGerant974 ou boris.payet@gmail.com" required>
        </div>

        <!-- Password -->
        <div class="form-group">
            <label>Mot de Passe : </label>
            <input type="password" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="**********" required>
        </div>
