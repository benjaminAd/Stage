        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <FONT size="4pt">
                <p>Vous avez un projet ? Vous avez une super idée ?
                    Mais vous n'avez ni les <strong>compétences</strong> ni les moyens pour le <strong>réaliser</strong>
                </p>

                <p>Vous voulez monter une startup ? Vous mettre à votre compte ? Mais vous ne savez pas faire un
                    business plan ou une étude de marché ? Vous avez besoin de conseil particulier ou besoin de
                ...
                <p>Une communauté de jeunes réunionnais au service de vos projets.
                    Faites <strong>confiance</strong> à la jeunesse réunionnaise, vous leur permettez de monter en
                    compétences sur un de vos projets et votre projet vous coutera bien moins cher qu'un expert.
                    Attention, il faut leur laisser un peu de temps afin que la <strong>réalisation</strong> réponde à
                    vos besoins…
                    Ne vous inquiétez pas, ceux-ci sont <strong>accompagnés</strong>, aidés et suivis par les experts de
                    <strong>CONNECTANOU</strong>.
                </p>

                <h2>CONNECTANOU, Comment ça fonctionne concrètement ?</h2>
                <p>
                    Afin de déposer votre mission, il suffit de vous inscrire sur <strong>CONNECTANOU</strong> et
                    remplir le formulaire de dépôt de projet. Vous allez recevoir un mail de validation ou de
                ...
                <P>
                    Si vous souhaitez être accompagner pour définir votre <strong>besoin</strong>, nous pouvons vous
                    aider pour la rédaction de votre cahier des charges. N’hésitez pas à nous <a href="contact.php">contacter</a>.
                </p>
            </FONT>
            <p> &nbsp;</p>
            <p> &nbsp;</p>
