            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                <FONT size="4pt">
                    ...
                    <p><strong>Connectanou</strong> te propose des missions qui proviennent des <strong>projets de
                            petites entreprises ou associations réunionnaises</strong> qui n'ont pas forcément les
                    ...
                    <p>Vous pouvez rechercher et parcourir tous les <strong>projets</strong> déposés par les <strong>entrepreneurs</strong>,
                        choisir celui ou ceux qui répondent à vos compétences ou vos valeurs. Par contre, pour entrer en
                        contact et négocier avec le porteur de projet, il faut être inscrit sur
                        <strong>CONNECTANOU</strong>. Une fois le projet réalisé, vous recevrez le nb de points sur
                        votre profil. Si l'évaluation est excellente, vous recevrez des points supplémentaires.</p><br>
                    <p>Vous pouvez également rédiger des articles (conseils sur une de vos compétences) pour
                        <!-- <a href=""> -->le blog de Connectanou</a>, vous serez récompensez également en points.</p>
                    <br>
