...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-light shadow-sm">
        <div class="container">
            <a class="navbar-brand ml-auto" href="/ConnectanouLaravel/public/"><img
                    src="{{ asset('img/logoconnect.png')}}" width="120px;" class="pr-2" alt="">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="/ConnectanouLaravel/public/realisateur"><strong>Réalisateur</strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/ConnectanouLaravel/public/porteur"><strong>Porteur de
                                projet</strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="/ConnectanouLaravel/public/a-propos"><strong>L'association</strong></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="/ConnectanouLaravel/public/contact"><strong>Contact</strong></a>
                    </li>
                    {{-- <li class="nav-item">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link active"
                               href="{{ route('login') }}"><strong>{{ __('Se connecter') }}</strong></a>
                        </li>
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link active"
                                   href="{{ route('register') }}"><strong>{{ __('S\'enregistrer') }}</strong></a>
                            </li>
                        @endif
                    @else
